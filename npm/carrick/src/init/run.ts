...
function help(): string {
  return [
    ...
    "your agent loads. It runs no paid analysis and uploads nothing. Where Carrick",
    "already holds an index for these repos, it reads that index into .carrick so",
    "this machine can answer from it. That read also re-reads your source here,",
    "which takes minutes on a large workspace, unless .carrick already holds an",
    "index current for this checkout. Nothing is written, here or in Carrick,",
    "until you accept what it proposes.",
    "",
