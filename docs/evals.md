...
| `CARRICK_INTENT_CONCURRENCY=N` | Concurrent `/generate-intent` calls per dependency level (default 20; `CARRICK_CONCURRENCY_LIMIT`, default 28, caps model calls in flight across the scan, shared with file analysis) |
